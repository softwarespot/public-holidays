...
# Use this image (~50MB) to run the "public-holidays-cli", as the Go image contains too much bloat,
...
COPY --from=builder /go/src/public-holidays/public-holidays-cli ./
EXPOSE 10000
CMD ["./public-holidays-cli"]
